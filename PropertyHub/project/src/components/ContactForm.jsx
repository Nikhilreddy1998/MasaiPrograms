...
import { addUserInquiry } from '../store/slices/authSlice.js';
...
const ContactForm = ({ property, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Add inquiry to store
    dispatch(addUserInquiry({
      ...formData,
          ...
          <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                Thank you for your interest in {property.title}. {property.agent.name} will contact you soon.
              </p>
              <button
                onClick={onClose}
